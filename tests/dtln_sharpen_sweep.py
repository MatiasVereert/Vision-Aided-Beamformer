...
def main():
    ...
    processors_dict = {
        "Oracle_soft_ref_alpha_0.99": ORACLE_MB_MVDR_SOUDEN_Processor(min_loading=1e-6, alpha=ALPHA, sharpen_exp=1.0),
    }
    for e in SHARPEN_EXPS:
        processors_dict[f"DTLN_exp{e:g}_alpha_0.99"] = DTLN_MB_MVDR_SOUDEN_Processor(
