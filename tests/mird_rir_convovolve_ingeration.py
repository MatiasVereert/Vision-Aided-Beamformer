...
def run_mird_mvdr_evaluation():
    ...
    interpreter_1 = tf.lite.Interpreter(model_path=r"data/dnn_models/model_quant_1.tflite")
    interpreter_1.allocate_tensors()

    interpreter_2 = tf.lite.Interpreter(model_path=r"data/dnn_models/model_quant_2.tflite")
