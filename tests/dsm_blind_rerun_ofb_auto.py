"""
Corre SOLO NM_MVDR_OFB_AUTO(smooth=0.2) sobre el barrido de iSIR ya existente
(los demas procesadores no cambian; no hace falta recalcularlos). Agrega/
actualiza IN-PLACE las filas 'NM_MVDR_OFB_AUTO' de isir_sweep_metrics.csv y
nonintrusive_sweep_metrics.csv (el resto de las filas queda intacto) y
regenera los 4 PNG del barrido.

Uso
---
    python tests/dsm_blind_rerun_ofb_auto.py
"""
import os
...
def main():
    ...
    proc = NM_MVDR_OFB_AUTO(smooth=0.2)
