...
block_shift = 128
# load models
interpreter_1 = tflite.Interpreter(model_path= r'tools\data\redes\model_1.tflite')
interpreter_1.allocate_tensors()
interpreter_2 = tflite.Interpreter(model_path= r'tools\data\redes\model_2.tflite')
...
audio,fs = sf.read(r'tests\data\spp_mvdr_dtln_tflite_output\1A_FF_input_mic0_16k.wav')
