...
def MVDR_l_recursive_mask_based(X_stft, mask_s, mask_n, min_loading=1e-6, save_weights=False):
    ...
    # -----------------------------------------------------------------
    # PAPER MODIFICATION: Accumulators instead of exponential smoothing
    # -----------------------------------------------------------------
    ...
    for m in range(T):
        ...
        # -----------------------------------------------------------------
        # PAPER MODIFICATION: Strict cumulative sum (Equation 4)
        # -----------------------------------------------------------------
        ...
        # Added a tiny epsilon (1e-15) to prevent division by zero in the first frames
